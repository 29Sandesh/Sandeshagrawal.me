        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16">
          ...
          >
            <p className="text-xl md:text-3xl font-light text-white leading-relaxed font-sans">
              I am <span className="text-white font-bold">Sandesh Agrawal</span>, a Frontend Developer dedicated to building <span className="italic">exceptional</span> digital experiences that seamlessly blend technical logic with visual storytelling.
            </p>

            <div className="h-px w-24 bg-white/20"></div>

            <p className="text-white/60 text-base md:text-lg font-light leading-relaxed">
              With over 3 years of experience in the React ecosystem, my work is centered on building high-performance, modular frontend architectures. I believe that every line of code should contribute to a meaningful user journey.
            </p>
          </motion.div>
          ...
          >
            <div className="grid grid-cols-2 gap-x-6 gap-y-8 border-l border-white/10 pl-8 md:pl-10 relative">
              ...
              <div>
                ...
                <p className="text-white text-sm tracking-wide uppercase">15+ Completed</p>
              </div>
              <div>
